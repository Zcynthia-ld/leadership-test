...
const typeDescriptions = {
    ...
    wood: {
        ...
        description: "您是一位注重团队发展和人才培养的领导者，善于创造协作环境，激发团队潜能。典型人物如《三国演义》中孙权『劝学吕蒙』促成士别三日、『纳鲁肃榻上策』定鼎江东，其性格隐忍坚韧且知人善任，以包容胸襟凝聚江东才俊。您重视每个成员的成长，愿意投入时间指导和培养人才。您的管理风格鼓励创新和尝试，能够在保持团队和谐的同时推动变革。您擅长构建团队凝聚力，促进成员间的相互支持。",
    ...
    fire: {
        ...
        description: "您是一位充满激情和驱动力的领导者，擅长激励团队追求卓越和突破。典型人物如《三国演义》中张飞『当阳桥怒吼』震慑千军、『义释严颜』化敌为友，其性格豪迈率真且忠勇无双，凭赤胆热血铸就团队魂魄。您对目标有强烈的关注，能够持续推动团队向前。您的能量和热情具有感染力，能够点燃团队的工作热情。您勇于面对挑战，在竞争中保持进取精神，不断寻求突破和创新。",
